...
const surveySchema = new Schema(
  {
    ...
    loftIncluded: { type: Boolean, default: false },
    loftType: { type: String, enum: Object.values(LOFT_TYPES), required: true },
    loftArea: { type: Number, required: true },
    ...
    buidingAge: { type: String, enum: Object.values(BUILDING_AGES), required: true },
